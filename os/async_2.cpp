...
// Reference: https://eli.thegreenplace.net/2016/the-promises-and-challenges-of-stdasync-task-based-parallelism-in-c11/#id4
...
int main() {
    ...
    future<int> fut = async(launch::async, accumulate_block_worker_ret, v.data(), v.size());
