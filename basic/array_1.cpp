 ...
 * But when numbers of key growing, we can use linked list to prevent conflict, look up time will be O(N)
 * Or We can use Balanced Binary Search Tree, which look up time will be O(logN)
 * 
 */
